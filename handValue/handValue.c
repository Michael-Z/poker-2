...
* Last Modified : Thu 10 Mar 2011 12:34:54 AM EST
...
char cardToChar (int rank)
{
	...
	if ((rank>0)&&(rank < 10)) sprintf(temp, "%d", rank);
	else if (rank == 10) ret = 'T';
	else if (rank == 11) ret = 'J';
	else if (rank == 12) ret = 'Q';
	else if (rank == 13) ret = 'K';
	else if (rank == 14) ret = 'A';
	else ret = temp[0];
	free(temp);
	return ret;
}
...
float computePreFlop(Card *myCards)
{
	...
	//Group5 hands:
	else if ((strcmp(cards,"77o"))==0||(strcmp(cards,"87s"))==0||(strcmp(cards,"Q9s"))==0||(strcmp(cards,"T8s"))==0||(strcmp(cards,"KJo"))==0||(strcmp(cards,"QJo"))==0||(strcmp(cards,"JTo"))==0||(strcmp(cards,"76s"))==0 \
	...
	//Group6 hands:
	else if ((strcmp(cards,"66o"))==0||(strcmp(cards,"ATo"))==0||(strcmp(cards,"55o"))==0||(strcmp(cards,"86s"))==0||(strcmp(cards,"KTo"))==0||(strcmp(cards,"QTo"))==0||(strcmp(cards,"54s"))==0||(strcmp(cards,"K9s"))==0 \
	||(strcmp(cards,"J8s"))==0)
	{
		returnValue = 0.68;
	}
	//Group7 hands:
	else if ((strcmp(cards,"44o"))==0||(strcmp(cards,"J9o"))==0||(strcmp(cards,"43s"))==0||(strcmp(cards,"75s"))==0||(strcmp(cards,"T9o"))==0||(strcmp(cards,"33o"))==0||(strcmp(cards,"98o"))==0||(strcmp(cards,"64s"))==0 \
	...
	//Group8 hands:
	else if ((strcmp(cards,"87o"))==0||(strcmp(cards,"53s"))==0||(strcmp(cards,"A9o"))==0||(strcmp(cards,"Q9o"))==0||(strcmp(cards,"76o"))==0||(strcmp(cards,"42s"))==0||(strcmp(cards,"32s"))==0||(strcmp(cards,"96s"))==0 \
